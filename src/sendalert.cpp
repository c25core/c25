...
2. run c25d with -printalert or -sendalert like this:
   /path/to/c25d -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see http://www.c25.website";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    alert.setSubVer.insert(std::string("/C25 Core:2.5.0.1/"));
