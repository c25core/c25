...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "C25Network") type = C25Network;
    if(strType == "C25NetworkVariable") type = C25NetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == C25Network) s = "C25Network";
    if(type == C25NetworkVariable) s = "C25NetworkVariable";
