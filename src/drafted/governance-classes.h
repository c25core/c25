 ...
 *
 *   // network
 *   CC25Network lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.c25.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CC25Network : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: C25Network
// //   -- signature requirements : Key1(User)
// class CC25NetworkVariable : public CGovernanceObject
// {
// private:
