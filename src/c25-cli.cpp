...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("C25 Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  c25-cli [options] <command> [params]  " + _("Send command to C25 Core") + "\n" +
                  "  c25-cli [options] help                " + _("List commands") + "\n" +
                  "  c25-cli [options] help <command>      " + _("Get help for a command") + "\n";
