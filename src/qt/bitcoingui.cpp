    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("C25 Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a C25 address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and c25: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About C25 Core"), this);
    aboutAction->setStatusTip(tr("Show information about C25 Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for C25 Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your C25 addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified C25 addresses"));
    ...
    openAction->setStatusTip(tr("Open a c25: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the C25 Core help message to get a list with possible C25 Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("C25 Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to C25 network", "", count));
    } else {
...
{
    QString strTitle = tr("C25 Core"); // default title
