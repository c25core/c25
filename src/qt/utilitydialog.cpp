    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("C25 Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About C25 Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  c25-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the C25 in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 C25, 0.1 C25, 1 C25 and 10 C25 -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("C25 Core is shutting down...") + "<br /><br />" +
